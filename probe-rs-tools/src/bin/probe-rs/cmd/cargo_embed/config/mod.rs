...
pub struct Flashing {
    ...
    /// Skip the resetting of the chip before flashing. This can be useful if there is other tooling
    /// in place which resets the chip before flashing. It currently only works for RAM flashing.
    pub skip_reset: bool,
}
